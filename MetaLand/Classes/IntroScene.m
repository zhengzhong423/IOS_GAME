...
- (id)init
{
    ...
    // Hello world
    CCLabelTTF *label = [CCLabelTTF labelWithString:@"Helloworld" fontName:@"Chalkduster" fontSize:36.0f];
    ...
    CCButton *helloWorldButton = [CCButton buttonWithTitle:@"[ Start Game ]" fontName:@"Chalkduster" fontSize:18.0f];
